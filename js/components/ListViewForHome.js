...
import {StyleSheet, View, Text, ListView, PixelRatio, Platform, TouchableNativeFeedback, TouchableHighlight, Alert, Clipboard, ToastAndroid} from 'react-native';
...
class ListViewForHome extends Component{
    ...
    _itemOnPress(rowData){
		/*Alert.alert(
		  ...
		  [
			{text: '复制', onPress: () => Clipboard.setString(JSON.stringify(rowData))},
